...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-tt^j^-!u1_b-37zh2c+%d56jn2ti$z=4)srf!*=&v3v!2t$+xv')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'notification_db'),  # Default: notification_db
        ...
        'PORT': os.getenv('DB_PORT', '5434'),  # Default: 5434
    }
}
